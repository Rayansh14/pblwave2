"""
Django settings for pblwave2 project.
...
WSGI_APPLICATION = 'pblwave2.wsgi.application'
...
try:
    ...
    print('Looks like no local settings file is here. You must be on production.')
